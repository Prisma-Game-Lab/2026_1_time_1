...
// Ataque de chao do Nezha: faz um hazard COBRIR o chao da arena por X segundos.
// Reutiliza a logica das raizes do Anhanga: fase de AVISO (sem dano) -> ATIVO (com dano) -> some.
// O dano/knockback ficam no ChifreCollider do prefab do hazard (o mesmo componente que a raiz usa).
